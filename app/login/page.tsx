    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        html, body { 
          ...
          overscroll-behavior: none; /* Mobildeki esneme/sekme efektini kapatır */
        }
      `}} />
        ...
        <div className="relative z-10 w-full max-w-md p-8 bg-[#0d1117]/80 backdrop-blur-xl border border-white/5 rounded-2xl shadow-2xl">
          ...
          <form className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <a href="/reset-password" className="text-[11px] text-emerald-400 hover:text-emerald-300 transition-colors duration-200">
                  Şifremi Unuttum
                </a>
              </div>
              <input 
          ...
          <div className="mt-8 text-center">
            <span className="text-sm text-zinc-500">
              Hesabın yok mu?{" "}
              <a href="/register" className="text-emerald-400 hover:text-emerald-300 font-medium transition-colors duration-200">
                Hemen Kayıt Ol
              </a>
            </span>
          </div>
